...
public class ClientsController : ControllerBase
{
    ...
    public async Task<ActionResult<PagedResult<ClientDto>>> GetPaged(
        ...
        [FromQuery] Guid? homeLocationId, [FromQuery] bool mineFirst = false)
    {
        return Ok(await _clientService.GetPaged(
            this.CurrentOrganizationId(), request, tagId, homeTrainerId, homeLocationId, mineFirst, this.CurrentUserId()));
    }
